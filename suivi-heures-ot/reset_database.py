...
Supprime toutes les données existantes et recrée les tables avec les données de test.

À utiliser en cas de problème avec les comptes utilisateurs.
"""
